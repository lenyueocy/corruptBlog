...
if ($action== 'addlink') {
	...
	$Link_Model->addLink($sitename, $siteurl, $description, $taxis, $sitepic);
	$CACHE->updateCache('link');
...
if ($action=='update_link') {
	...
	$Link_Model->updateLink(array('sitename'=>$sitename, 'siteurl'=>$siteurl, 'sitepic'=>$sitepic, 'description'=>$description), $linkId);
