...
<li <?php echo $hide_; ?>><a href="./comment.php?<?php echo $addUrl_1 ?>">全部</a></li>
<li <?php echo $hide_y; ?>><a href="./comment.php?hide=y&<?php echo $addUrl_1 ?>">待审
<?php
$hidecmnum = ROLE == ROLE_ADMIN ? $sta_cache['hidecomnum'] : $sta_cache[UID]['hidecommentnum'];
if ($hidecmnum > 0) echo '('.$hidecmnum.')';
?>
</a></li>
<li <?php echo $hide_n; ?>><a href="comment.php?hide=n&<?php echo $addUrl_1 ?>">已审</a>
</li>
<?php endif; ?>
  ...
  <table class="table table-striped table-bordered table-hover dataTable no-footer">
    <thead>
      <tr>
        ...
        <th width="300" class="hidex"><b>评论者</b></th>
	...
	?>
     <tr>
        ...
        <td class="hidex"><?php echo $poster;?> <?php echo $mail;?> <?php echo $ip;?> 
    ...
    <input name="operate" id="operate" value="" type="hidden" />
                          ...
                          <div class="panel-body">
                              <div class="pagination">
                                  <ul><?php echo $pageurl; ?> (有<?php echo $cmnum; ?>条评论)
                               </ul>
                              </div>
                          </div>
                      </section>
