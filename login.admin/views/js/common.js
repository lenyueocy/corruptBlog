...
function addattach_img(fileurl,imgsrc,aid, width, height, alt){
    //alert('请先切换到所见所得模式');
    tinyMCE.execCommand('mceInsertContent',false,'<p><a target=\"_blank\" href=\"'+fileurl+'\" id=\"ematt:'+aid+'\"><img src=\"'+imgsrc+'\" title="点击查看原图" alt=\"'+alt+'\" border=\"0\" width="'+width+'" height="'+height+'"/></a></p>');
    //tinyMCE.insertImage("http://blog.chenziwen.com/admin/views/images/login_logo.png", alt, border, hspace, vspace, 100, 100, align, title, onmouseover, onmouseout);
	//if (editorMap['content'].designMode === false){
		//alert('请先切换到所见所得模式');
	//}else if (imgsrc != "") {
	    
	    //tinyMCE.insertImage(imgsrc, alt, border, hspace, vspace, 100, 100, align, title, onmouseover, onmouseout);
