...
<script>setTimeout(function(){$(".hideActived").remove();},2600);</script>

<?php if (isset($_GET['activated'])): ?>

                              <section class="panel  hideActived">
            ...
            <div class="panel-body">
                <div class="panel-group" id="accordion">
                    ...
                    <form action="widgets.php?action=setwg&wg=custom_text" method="post" class="form-inline">
                                                  ...
                                                  <div class="form-group"    id="custom_text_new"  style="display:none;" >

                    
                                  <label class="control-label" for="title">组件名</label>

                            <li><input type="text" class="form-control" name="new_title" value="" /></li>
                                  <label class="control-label" for="message">内容 （支持html）</label>
                                  
                            <li><textarea name="new_content" class="form-control" rows="10" style="width:350px;overflow:auto;"></textarea></li>
                            <br/>
