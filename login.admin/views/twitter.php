...
<?php endif;?>
    ...
    <div class="box_1">
    <textarea class="box comment" name="t" id="comment"></textarea>
    </div>
    ...
    <div id="faceWraps"><?php include View::getView('smiley')?></div>
...
$(document).ready(function(){
	...
	$("#custom_file_upload").uploadify({
		...
		wrap.children().unbind('click').click(function () {	$("textarea").focus();
