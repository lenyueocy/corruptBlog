...
<header class="header">
    ...
    <section class="infos">
        <div class="container">
			...
			$row=mysql_fetch_array(mysql_query("SELECT date FROM ".DB_PREFIX."blog WHERE gid=".$logid));
			?>
			<div class="fields">
                ...
                <span><i class="czs-talk-l"></i> <?php echo $value['comnum']==null?'0':$value['comnum']; ?> 评</span> / 
