...
<section class="posts main-load">
    <div class="container">
		...
		$row=mysql_fetch_array(mysql_query("SELECT date FROM ".DB_PREFIX."blog WHERE gid=".$value['gid']));
		?>
            <article class="meta" itemscope="" itemtype="http://schema.org/BlogPosting">
                ...
                <footer>
                    <span class="time"><time datetime="<?php echo gmdate('Y-n-j', $value['date']); ?>" itemprop="datePublished" pubdate=""><?php echo diyTime($row['date']);?>
