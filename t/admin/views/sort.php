...
<form  method="post" action="sort.php?action=taxis">
    <table class="table table-striped table-bordered table-hover dataTable no-footer">
        <thead>
            <tr>
                <th width="90"><b>序号</b></th>
                <th width="160"><b>名称</b></th>
                <th width="140"class="hide"><b>描述</b></th>
                <th width="130"><b>别名</b></th>
                <th width="90" ><b>模板</b></th>
                ...
                foreach ($sorts as $key => $value):
                    ...
                    <tr>
                        <td>
                            ...
                            <input class="form-control em-small" name="sort[<?php echo $value['sid']; ?>]" value="<?php echo $value['taxis']; ?>" maxlength="4" />
                        </td>
                        <td class="sortname">
                            <a href="sort.php?action=mod_sort&sid=<?php echo $value['sid']; ?>"><?php echo $value['sortname']; ?></a>
                        </td>
                        <td class="hide"><?php echo $value['description']; ?></td>
                    ...
                    foreach ($children as $key):
                        ...
                        <tr>
                            <td>
                                <input type="hidden" value="<?php echo $value['sid']; ?>" class="sort_id" />
                                <input class="form-control" name="sort[<?php echo $value['sid']; ?>]" value="<?php echo $value['taxis']; ?>" />
                            </td>
...
<form action="sort.php?action=add" method="post" class="form-inline">
    <div id="sort_new" class="form-group" style="display:none">
        <li>
                    <label>序号</label><br/>
